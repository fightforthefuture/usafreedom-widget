...
var animations = {
    modal: {
        ...
        start: function() {
            ...
            setTimeout(stupidIEZoomFix, 150);
        ...
        postUser: function() {
            ...
            var action_comment = $('.letter .content')[0].textContent.trim()+'\n';
            ...
            doc['hp_enabled'] = true;
            doc['tag'] = 'ifeelnaked';
            doc['subject'] = 'Please oppose the USA FREEDOM Act and end mass surveillance.';
            doc['action_comment'] = action_comment;  // JL HACK
            ...
            this.trackOptimizely('send_email');
        ...
        placePhonecall: function(num) {
            ...
            var data = {
                campaignId: 'ifeelnaked', 
                userPhone: num,
                fftfCampaign: 'ifeelnaked',
                fftfReferer: host,
                fftfSession: session
            }
            if (this.zipcode)
